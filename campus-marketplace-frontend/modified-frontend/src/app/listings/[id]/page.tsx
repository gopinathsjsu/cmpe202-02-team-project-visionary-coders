            ...
            <div className="max-w-7xl mx-auto mb-8 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">View full details about this listing.</p>
                    </div>
                </div>
                <div className="flex gap-3">
                    <button className="p-2 bg-white rounded-lg border border-gray-200 hover:bg-gray-50 text-gray-600">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                        ...
                        <div className="relative aspect-square w-full bg-[#F8F9FA] rounded-xl overflow-hidden flex items-center justify-center mb-6">
                            {listing.photo_url ? (
                                <img
                ...
                <div className="lg:col-span-7 space-y-6">
                    <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                        <h2 className="text-lg font-semibold text-gray-900 mb-2">Product Detail</h2>
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="w-full p-4 bg-white border border-gray-200 rounded-lg text-gray-700">
                                    {listing.title}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="w-full p-4 bg-white border border-gray-200 rounded-lg text-gray-600 min-h-[120px]">
                                    {listing.description}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="w-full p-4 bg-white border border-gray-200 rounded-lg text-gray-700 flex justify-between items-center">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="w-full p-4 bg-white border border-gray-200 rounded-lg text-gray-900 font-semibold flex items-center">
                            ...
                            <div className="pt-4">
                                <div className="flex gap-4">
                                    <button className="flex-[3] bg-indigo-600 text-white font-bold py-4 rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200">
                                        Make an Offer
                                    </button>
                                    <button className="flex-[1] bg-white border-2 border-gray-200 text-gray-700 font-bold py-4 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center">
